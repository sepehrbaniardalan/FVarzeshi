...
export default function Header() {
  return (
     <div className="relative w-full">
      ...
      <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-full max-w-5xl px-1 flex justify-center ">
        <div className="relative w-full">
          <input type="text" placeholder="محصول مورد نظر خود را جستجو کنید..." dir="rtl" className="w-full bg-white text-right text-[25px] text-neutral-700 placeholder-neutral-400 outline-none pl-5 pr-14 py-9 shadow-[0_6px_20px_rgba(0,0,0,0.18)] rounded-sm" />
